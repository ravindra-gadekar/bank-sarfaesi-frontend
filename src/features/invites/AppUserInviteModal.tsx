  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md bg-sand-50 dark:bg-dark-surface rounded-2xl shadow-lg border border-sand-300 dark:border-dark-border p-6">
        <h3 id="app-invite-title" className="text-lg font-semibold mb-4 text-ink dark:text-dark-text">
          Invite App User
        </h3>
        <form onSubmit={submit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-sand-300 bg-white text-ink focus:outline-none focus:ring-2 focus:ring-accent/30 focus:border-accent dark:bg-dark-bg dark:border-dark-border dark:text-dark-text"
            >
              {APP_ROLES.map((r) => (
